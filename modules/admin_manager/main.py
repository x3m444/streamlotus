...
from modules.admin_manager import lansare, planificare, nomenclator, rapoarte, firme, utilizatori
...
def show_admin():
    ...
    # --- TABURI PRINCIPALE ---
    tab_lansare, tab_monitor, tab_plan, tab_nom, tab_firme, tab_users = st.tabs([
        "🚀 Lansare Producție",
