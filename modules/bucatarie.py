...
def show_bucatarie():
    ...
    tab_gatire, tab_impachetare, tab_nevandut = st.tabs([
    ...
    with tab_nevandut:
        _render_nevandut(data_selectata)
...
# ---------------------------------------------------------
# SECTIUNEA: DECLARA NEVANDUT
# ---------------------------------------------------------
def _render_nevandut(data_selectata):
    """
    Bucatarul vede stocul ramas (lansat - ambalat/livrat) si poate
    declara ce a ramas nevandut. Ghiseul va putea oferi aceste portii
    angajatilor firmelor cu contract.
    """
            ...
            with st.container(border=True):
                ...
                with col_info:
                    ...
                    if deja_declarat:
                        ...
                        st.caption(f"Declarat nevândut: {deja_declarat['cantitate']} | Servit: {deja_declarat['cantitate_servita']} | Disponibil: {ramas_nev}")
